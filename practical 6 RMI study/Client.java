...
public static void main (String[] args)
{
    ...
    //String name = "rmi://localhost:9999/RoomBookingSystem"; //connect on localhost on port 9999
        ...
        while( validChoice != false )
        {
            ...
            BufferedReader input = new BufferedReader(new InputStreamReader(System.in));System.out.println("");
...
int real_time = Integer.parseInt(check_time);//This checks whether a room is available given the room name, day and time.
String temp = rbi.checkRoom(check_room,real_day,real_time);
CO455 Distributed Operating System Lab
System.out.println(temp);
System.out.println("");
break;
case 3: System.out.println("Room Booking Service - Rooms can be booked from
8am to 8pm");
System.out.println("");
...
int realb_time = Integer.parseInt(book_time);//This checks whether a room is available, if it is it then reserves the room.
...
int can2_time = Integer.parseInt(can_time);String canc = rbi.cancelRoom(cancel_room,can_day2,can2_time);
