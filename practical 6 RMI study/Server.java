...
java.rmi.*; import
java.rmi.server.*;class RoomBookingServer extends UnicastRemoteObject implements
...
while((record = b.readLine()) != null){ num = (record.lastIndexOf (" ", record.length ())) + 1; tempRoom =
...
// Naming.bind (name, server);String name = "RoomBookingSystem";
